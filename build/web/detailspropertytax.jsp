        ...
        <div class="container" >
            <div class="signup-content">
                ...
                <div class="signup-form">
                    <form name="form" onsubmit="return insertDetails();" method="POST" class="register-form" action="detailspropertytaxaction.jsp" id="register-form" style="margin:5px 0px 5px 0px">
                        <div class="form-row">
                            <div class="form-group" style="width:90%; padding-left:50px">
                                ...
                                <div class="form-input">
                                    <label for="property_area" class="required">Property Area</label>
                                    <input type="text" name="property_area" id="property_area" required/>
                                </div>
                                 <div class="form-input">
                                    <label for="property_value" class="required">Property Value</label>
                                    <input type="text" name="property_value" id="property_value" required/>
                                </div>
                                 <div class="form-input">
                                    <label for="last_tax_payed_amount" class="required">Last Tax Payed Amount</label>
                                    <input type="text" name="last_tax_payed_amount" id="last_tax_payed_amount" required/>
                                </div>
                                   <div class="form-input">
                                    <label for="last_tax_payed_time" class="required">Last Tax Payed Time</label>
                                    <input type="date" name="last_tax_payed_time" id="last_tax_payed_time" placeholder="MM-DD-YYYY" required/>
				</div>
                            </div>
                        </div>
