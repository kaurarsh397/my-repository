...
<%
    ...
    String proof[] = new String[]{adhaar_card, matric_certificate, passport, pan_card, license, category_certificate};
...
%>        
            ...
            <div class="col-lg-4 p-2 mx-0" >        
                <div class="card rounded-0 border-bottom border-primary border-top-0 border-left-0 border-right-0 hover-shadow " >
                    <div class="card-body " >   
                        <%  if(!proof[proofId].equals("null")) { %>
                         <img src="<%=proof[proofId]%>"/>
                         <% } %>
        <%= proof_name %> Upload: <input type="file" name="<%= proof_name %>" /><br/> 
                    </div>
                </div>
            </div>
