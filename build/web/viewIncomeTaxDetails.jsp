...
<%
    ...
    ResultSet rst = mdb.viewIncomeTaxDetails(uidai_no);
   
    if(rst.next())
    { 
        
         String annual_salary= rst.getString("annual_salary");
         ...
         String income_tax= rst.getString("income_tax");
%>                   
...
<section class="page-title-section overlay" style="height: 500px" data-background="images/about2.jpg">
    ...
    <div class="row">
      <div class="col-md-8">
        ...
        <p class="text-lighten" style="font-size: 25px">To your UID Income Tax details</p>
      </div>
    </div>
    </div>
    </center>     
