        ...
        <div class="container" >
            <div class="signup-content">
                ...
                <div class="signup-form">
                    <form name="form" onsubmit="return insertDetails();" method="POST" class="register-form" action="detailsincometaxaction.jsp" id="register-form" style="margin:5px 0px 5px 0px">
                        <div class="form-row">
                            <div class="form-group" style="width:90%; padding-left:50px">
                                ...
                                <div class="form-input">
                                    ...
                                    <input type="text" name="annual_salary" id="annual_salary" required/>
                                </div>
                                 <div class="form-input">
