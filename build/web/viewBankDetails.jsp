<%-- 
    Document   : viewBankDetails
    Created on : May 13, 2019, 6:37:09 PM
    Author     : DELL
--%>
...
<%
    ...
    ResultSet rst = mdb.viewBankDetails(uidai_no);
    if(rst.next())
    { 
        
         String bank_name= rst.getString("bank_name");
         String account_number = rst.getString("account_number");
         String account_open_date =rst.getString("account_open_date");
         String account_balance= rst.getString("account_balance");
         String loan_amount= rst.getString("loan_amount");
         String insurance_amount = rst.getString("insurance_amount");
...
<section class="page-title-section overlay" style="height: 500px" data-background="images/about2.jpg">
    ...
    <div class="row">
      <div class="col-md-8">
        ...
        <p class="text-lighten" style="font-size: 25px">To your UID Bank details</p>
      </div>
    </div>
    </div>
    </center>     
