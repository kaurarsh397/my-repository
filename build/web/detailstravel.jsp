        ...
        <div class="container" >
            <div class="signup-content">
                ...
                <div class="signup-form">
                    <form name="form" onsubmit="return insertDetails();" method="POST" class="register-form" action="detailstravelaction.jsp" id="register-form" style="margin:5px 0px 5px 0px">
                        <div class="form-row">
                            <div class="form-group" style="width:90%; padding-left:50px">
                                ...
                                <div class="form-input">
                                    <label for="means_of_travel" class="required">Means Of Travel</label>
                                    <input type="text" name="means_of_travel" id="means_of_travel" required/>
                                </div>
                                <div class="form-input">
                                    <label for="travel_departure_date" class="required">Travel Departure Date</label>
                                    <input type="date" name="travel_departure_date" id="travel_departure_date" placeholder="MM-DD-YYYY" required/>
				</div>
                                <div class="form-input">
                                    <label for="travel_arrival_date" class="required">Travel Arrival Date</label>
                                    <input type="date" name="travel_arrival_date" id="travel_arrival_date" placeholder="MM-DD-YYYY" required/>
				</div>
                                <div class="form-input">
                                    <label for="travel_expense" class="required">Travel Expense</label>
                                    <input type="text" name="travel_expense" id="travel_expense" required/>
                                </div>
