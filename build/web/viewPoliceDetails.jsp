<%-- 
    Document   : viewPoliceDetails
    Created on : May 13, 2019, 8:55:00 PM
    Author     : DELL
--%>
...
<%
    ...
    ResultSet rst = mdb.viewPoliceDetails(uidai_no);
   
    if(rst.next())
    { 
        
         String case_no= rst.getString("case_no");
         String case_details = rst.getString("case_details");
         String year =rst.getString("year");
         String state= rst.getString("state");
         String status_of_case= rst.getString("status_of_case");
%>                   
...
<section class="page-title-section overlay" style="height: 500px" data-background="images/about2.jpg">
    ...
    <div class="row">
      <div class="col-md-8">
        ...
        <p class="text-lighten" style="font-size: 25px">To your UID Police details</p>
      </div>
    </div>
    </div>
    </center>     
