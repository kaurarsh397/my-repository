        ...
        <div class="container" >
            <div class="signup-content">
                ...
                <div class="signup-form">
                    <form name="form" onsubmit="return insertDetails();" method="POST" class="register-form" action="detailsmedicalaction.jsp" id="register-form" style="margin:5px 0px 5px 0px">
                        <div class="form-row">
                            <div class="form-group" style="width:90%; padding-left:50px">
                                ...
                                <div class="form-input">
                                    <label for="treatment_name" class="required">Treatment Name</label>
                                    <input type="text" name="treatment_name" id="treatment_name" required/>
                                </div>
                                 <div class="form-input">
                                    <label for="hospital_name" class="required">Hospital Name</label>
                                    <input type="text" name="hospital_name" id="hospital_name" required/>
                                </div>
                                 <div class="form-input">
                                    <label for="hospital_address" class="required">Hospital Address</label>
                                    <input type="text" name="hospital_address" id="hospital_address" required/>
                                </div>
                                <div class="form-input">
                                    <label for="hospital_expenses" class="required">Hospital Expenses</label>
                                    <input type="text" name="hospital_expenses" id="hospital_expenses" required/>
                                </div>
                                 <div class="form-input">
                                    <label for="treatment_year" class="required">Treatment Year</label>
                                    <input type="date" name="treatment_year" id="treatment_year" placeholder="MM-DD-YYYY" required/>
				</div>
                            </div>
                        </div>
