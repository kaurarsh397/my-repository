...
<body>
	...
	<div class="bg-contact3" style="background-image: url('images/bg-01.jpg');">
		<div class="container-contact3">
			<div class="wrap-contact3"  style="margin-top: 40px;width:1500px">
				<form  class="contact3-form validate-form" action="AddServiceProviderAction.jsp" method="post" >
                                  
                                   <div id="main"class="bg-white p-5"style="width:1120px; margin-right:40px">
                                    <center><h4>UID Holders List</h4></center>
                                    <br/> 
