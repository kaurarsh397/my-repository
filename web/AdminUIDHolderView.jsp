...
<body>
    ...
    System.out.println("uidno "+uidai_no);
    
    MyDatabase mdb=new MyDatabase(application);
    ResultSet rst =mdb.checkUser(uidai_no);
    if(!rst.next())
    {
        %>
        <jsp:forward page="AdminUIDHolderViewForm.jsp">
    ...
    %>
		...
		<div class="container-contact3">
			<div class="wrap-contact3"  style="width:1160px">
                            


<div id="mySidenav" class="sidenav" style="background-color:#80c64a">
...
<!-- page title -->
<section class="page-title-section overlay" style="height: 90px" data-background="images/about2.jpg">
    <center>
    <div class="container" style="margin-left:100px ;margin-top: 5px">
    <div class="row">
      <div class="col-md-8">
          
        <ul class="list-inline custom-breadcrumb">
          <li class="list-inline-item"><a class="h2 text-primary font-secondary" Style="font-size: 50px">UID No : <%= uidai_no %></a></li>
...
<section class="section bg-cover" data-background="images/backgrounds/success-story.jpg">
  <div class="container" >
    <div class="row" style="width: 900px; margin-left: 0px">
      <div  id="main" class="col-lg-6 col-sm-8"style="width: 900px; margin-right:20px">
  ...
  <span style="font-size:30px;cursor:pointer;margin-top: 0px" onclick="openNav()">&#9776;View Details</span>
      ...
      <div class="container-contact3-form-btn">
                                            ...
                                            <a href="AdminUIDHolderViewForm.jsp" ><input type="button" class="contact3-form-btn" value="view another uid" /></a>
                                            </center>
    </div>
</section>
			</div>
