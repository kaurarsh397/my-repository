				...
				<div class="login100-form-title" style="background-image: url(loginimages/bg-01.jpg);">
					<span class="login100-form-title-1">
						User Update Login
                            ...
                            <form class="login100-form validate-form" method="post" action="UIDupdateform.jsp">
					...
					<div class="wrap-input100 validate-input m-b-18" data-validate = "DOB is required">
						...
						<input class="input100" type="date" name="date_of_birth" placeholder="Enter Date Of Birth">
						<span class="focus-input100"></span>
					</div>					
